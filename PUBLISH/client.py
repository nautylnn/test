...
PORT = 1883
# ACCESS_TOKEN = "iot_device_2"
# ACCESS_USERNAME = "iot_device_2"
ACCESS_TOKEN = "DEVICE1"
ACCESS_USERNAME = "DEVICE1"
...
client = mqttclient.Client("DEVICE1")
# client = mqttclient.Client("DEVICES2")
